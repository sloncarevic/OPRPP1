...
public class ElementsGetterDemo {
	...
	public static void test1() {
		Collection<String> col = new ArrayIndexedCollection<>();//stvoriPraznuKolekciju(); // npr. new ArrayIndexedCollection();
		col.add("Ivo");
		col.add("Ana");
		col.add("Jasna");
	...
	public static void test4() {
		Collection<String> col = new ArrayIndexedCollection<>(); //tvoriPraznuKolekciju(); // npr. new ArrayIndexedCollection();
		col.add("Ivo");
		col.add("Ana");
		col.add("Jasna");
