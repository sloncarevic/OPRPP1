...
public class ArrayIndexedCollection<T> implements List<T> {
	...
	private T[] elements;		//array of object references
	...
	public ArrayIndexedCollection(Collection<? extends T> other, int initalCapacity) {
		...
		this.elements = (T[]) new Object[(initalCapacity > other.size() ? initalCapacity : other.size())];
		this.addAll(other);
	...
	public void insert(T value, int position) {
		...
		T[] tempArray = this.elements.clone();
	...
	private static class ArrayIndexedCollectionElementsGetter<T> implements ElementsGetter<T> {
		...
		private final ArrayIndexedCollection<T> arrayIndexedCollection;
		
		private int nextToGet;
		
		private long savedModificationCount;
		
		private ArrayIndexedCollectionElementsGetter(ArrayIndexedCollection<T> arrayIndexedCollection) {
